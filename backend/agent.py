...
#    ),
    ...
    @function_tool(name="update question count",  description="Call this function after each interview question is completed and you move to the next question in the given question list")
