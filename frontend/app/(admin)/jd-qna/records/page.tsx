...
import { ArrowLeft, ChevronRight, Briefcase, Clock, BarChart3, Database, Sparkles, FileText } from "lucide-react";
        ...
        <motion.div 
          ...
          <div className="space-y-2 text-center justify-center mb-10 flex flex-col items-center">
            ...
            >
              ...
              <span className="text-sm font-medium">AI-Powered Job Skill Records</span>
            </motion.div>
            <h1 className="text-4xl md:text-5xl font-bold text-[#1D244F] text-center justify-center">Job Skill Records</h1>
      ...
      >
        {records.length === 0 ? (
          <div className="col-span-full text-center py-8">
            <p className="text-[#5B5F79] mb-6 text-lg">No job records found.</p>
            <Button 
              asChild
            ...
            >
              <Card className="relative bg-white border border-[#F7F7FA] hover:border-[#2663FF]/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500">
                ...
                <CardHeader className="relative z-10">
                  <CardTitle className="text-xl font-bold text-[#1D244F] truncate">{record.jobTitle}</CardTitle>
                ...
                <CardContent className="relative z-10">
                  ...
                  >
                    <Link href={`/jd-qna/records/${record.id}`} className="flex items-center justify-center">
                      View Details 
